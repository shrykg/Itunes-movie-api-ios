...
internal func exerciseOne() {
    ...
    let string = "\(firstName) \(lastName) lives at \(streetName) in \(city),\(state), \(postCode). If you want to contact \(title). \(lastName), you can email \(emailAddress) or call at \(cellPhoneNumber)."
//    print(string)
